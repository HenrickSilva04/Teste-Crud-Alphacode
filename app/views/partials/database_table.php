    ...
    ?>
            <tr class="table_data mt-5 mb-5 p-5">
                ...
                <td class="text-center align-middle">
                    <button class="btn"><a href="/TesteCrudAlphacode/edit_page.php?id=<?php echo $row['id'];?>"><img src="public/assets/editar.png" alt="edit_ast"></a></button>
                    <button class="btn"><a href="/TesteCrudAlphacode/delete.php?id=<?php echo $row['id'];?>"><img src="public/assets/excluir.png" alt="delete.asset"></a></button>
                </td>
            </tr>
